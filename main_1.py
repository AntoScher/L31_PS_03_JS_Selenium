...
def print_paragraphs(driver, section=None):
...
def go_to_section(driver, section_index):
    ...
    contents = driver.find_elements(By.CSS_SELECTOR, ".toc li")
    if section_index < len(contents):
        contents[section_index].find_element(By.TAG_NAME, "a").click()
        time.sleep(2)
...
def main():
    ...
    section_choice = int(input("Enter the number of the section you want to go to: ")) - 1
